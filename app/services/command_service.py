...
🔗 링크 요약
  • 유튜브 URL 전송 - 자동 요약
  • 웹페이지 URL 전송 - 자동 요약
  • 네이버 블로그/Medium - 자동 요약

🤖 AI 기능
  • !ai [질문] - Azure OpenAI로 질문
  • !llm [질문] - Multi-LLM (Cerebras/Groq/Claude)
  • !rag [질문] - 웹 검색 기반 RAG 응답

🪙 암호화폐 (110개 지원)
  • !코인 [심볼] - 가격 조회
    예: !코인 BTC
  • !코인분석 [심볼] - 기술 지표 분석
    예: !코인분석 ETH (RSI, MACD, Bollinger Bands)
  • !내코인 - 보유 코인 조회
  • !김프 - 김치 프리미엄 조회
  • !코인등록 [심볼] [수량] [평단가]
    예: !코인등록 BTC 0.5 50000000
  • !코인삭제 [심볼] - 보유 코인 삭제
...
지원 암호화폐: BTC, ETH, SOL, XRP, BNB, ADA, DOGE, SHIB, PEPE, ARB, OP, SUI, RENDER 등 110개+
        """.strip()
